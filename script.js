async function foo(){
    ...
    <div class="box-part">
    <h5 class="text-center mb-3  mt-2"><span class="badge badge-secondary">குறள்-${result.number} </span></h5>
    <div class="d-flex flex my-2 justify-content-center">
    <span class="badge badge-light badge-pill badgecontrol">பால்: ${result.sect_tam} </span>
                     ...
                     <span class="badge badge-light badge-pill  badgecontrol">Chapter-Group: ${result.chapgrp_eng} </span>
                     <span class="badge badge-light badge-pill  badgecontrol">Chapter: ${result.chap_eng} </span>                        </div>   
